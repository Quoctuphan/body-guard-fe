...
export default function EquipmentAdd({onCancel}) {
    ...
    return(
        ...
        <div className="flex flex-col items-center w-full h-fit p-5 space-y-5">
            <h1 className='font-medium'>Add Equipment</h1>
            <div className='p-9 w-full border border-stone-200 shadow-md rounded-lg"'>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Button  htmlType="submit" className='bg-black text-blue-50'>Add</Button>
                                    </Form.Item>
                                    </div>
