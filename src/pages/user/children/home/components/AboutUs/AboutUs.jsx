...
export default function AboutUs() {
  return (
    <section
      id="about-us"
      className="max-w-[1440px] mx-auto w-full  grid grid-cols-1 lg:grid-cols-2  gap-5 lg:gap-0 overflow-hidden mb-[100px]"
    >
      <div>
        <div className="space-y-8 lg:space-y-12 sm:text-center lg:text-left lg:h-[432px] animate-fade-right transition-all ease-in-out animate-once animate-duration-[700ms]">
          ...
          <h1 className="text-[2.4rem] font-medium lg:text-[3rem] w-full lg:max-w-[300px]">
            Discover Our Security Legacy
          </h1>
          <p className="text-[1.4rem] text-gray-600 font-light lg:max-w-[400px]">
        ...
        <div className="mt-[40px] grid grid-cols-1 lg:grid-cols-2 gap-6 transition-all ease-in-out animate-fade-right  animate-once animate-duration-[700ms]">
          <div className="flex flex-row lg:flex-col justify-center  gap-6 lg:gap-[30px] md:pr-[4px]">
            <p className="flex flex-col gap-1 justify-center sm:items-center lg:items-start max-w-[100px]">
              <span className=" flex justify-center items-center px-5 py-[1px] rounded-3xl bg-blue-500 w-fit text-white font-light">
                01
              </span>{" "}
              <span className="text-[2.2rem] font-medium lg:text-[3rem]">
                100%
              </span>{" "}
              <span className="w-full text-right text-[1.4rem] whitespace-nowrap">
                Satisfied Clients
              </span>{" "}
            </p>
            <p className="flex flex-col gap-1 justify-center sm:items-center lg:items-start max-w-[100px]">
              <span className=" flex justify-center items-center px-5 py-[1px] rounded-3xl bg-red-500 w-fit text-white font-light">
                02
              </span>{" "}
              <span className="text-[2.2rem] font-medium lg:text-[3rem]">
                200+
      ...
      <div className="flex flex-col gap-5 sm:items-center">
        ...
        <div className="lg:space-y-20 w-full lg:px-[60px]">
          <p className="flex sm:flex-col flex-row sm:space-x-2 lg:space-x-0 sm:justify-center text-[1.8rem] font-medium transition-all ease-in-out animate-fade-left  animate-once animate-duration-[700ms]">
            <span>Customer-Centric</span>
            <span>Approach</span>
          </p>
          <p className="flex lg:justify-end justify-center w-full  text-[1.4rem] text-gray-600 font-light transition-all ease-in-out animate-fade-right  animate-once animate-duration-[700ms]">
